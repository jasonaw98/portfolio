      ...
      <div className={`bg-tertiary rounded-2xl ${styles.padding} min-h-[400px]`}>
        <motion.div variants={textVariant()}>
          ...
          <div className="flex mt-16 justify-around">
            ...
            {/* OpenSea */}
            <a href="https://opensea.io/Jasonaw" className="flex flex-col items-center hover:text-gray-400">
            ...
            {/* LinkTree */}
            <a href="https://linktr.ee/jasonaw" className="flex flex-col items-center hover:text-gray-400">
